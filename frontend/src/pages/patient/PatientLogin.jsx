...
const PatientLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Verify this user is a patient (exists in patients table)
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl max-w-md w-full p-8 md:p-10 relative z-10 animate-slide-up">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-gray-600 text-lg font-medium">Patient Login Portal</p>
        ...
        <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border-2 border-blue-100">
          <p className="text-center text-sm text-gray-700 font-medium">
            ...
            <br />
            <span className="font-bold text-blue-600">Ask your family member for assistance</span>
          </p>
        </div>
        ...
        {/* Registration link */}
        <div className="text-center p-4 bg-gradient-to-r from-green-50 to-teal-50 rounded-xl border-2 border-green-100">
        ...
        <div className="mt-6 pt-6 border-t-2 border-gray-100 text-center">
          ...
          <Link
            to="/login"
            className="inline-flex items-center justify-center px-6 py-3 border-2 border-purple-500 text-purple-600 rounded-xl hover:bg-purple-50 transition-all duration-300 font-semibold transform hover:scale-105 hover:shadow-md"
          >
            Switch to Family Login
          </Link>
        </div>
      </div>
